  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        type: { "0%": { width: "0ch" }, "100%": { width: "100%" } }, // typing effect
        blink: { "0%, 50%, 100%": { borderColor: "transparent" }, "25%, 75%": { borderColor: "white" } }, // cursor blink
      },
      animation: {
        ...
        type: "type 4s steps(30) forwards", // steps = approx nombre des caractères
